                        ...
                        <div className="grid grid-cols-3 gap-3">
                            {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((num) => (
                                <button
                                    ...
                                    className={`h-14 bg-[#F2F6FF] text-slate-700 rounded-2xl text-[20px] font-bold transition-all active:scale-95 border-transparent ${step === 'new' ? 'hover:bg-emerald-50 hover:text-emerald-600' : 'hover:bg-blue-50 hover:text-[#0064FF]'}`}
                                >
                                    {num}
                                </button>
                            ))}
